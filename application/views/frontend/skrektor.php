...
<!-- Navigation -->
        ...
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownPortfolio">
              ...
              <a class="dropdown-item clickedAtPage " href="http://localhost:8080/PA2/spmi/skrektor">SK Rektor terkait SPMI</a>
            </div>
          </li>
          <li class="nav-item">
  ...
  <ol class="breadcrumb" style="background-color:#003366;">
    ...
    <li class="breadcrumb-item active" aria-current="page" style="color:white;">SK Rektor</li>
  </ol>
</nav>
  <!-- Page Content -->
  <div class="container">
 ...
 -->
    ...
    <div class="row">
      ...
      <div class="col-lg-8">
        ...
        <!-- Date/Time -->
        <h3>Surat Keterangan Rektor</h3><!-- >Posted on January 1, 2017 at 12:00 PM</p> -->
        <br>
        <ul>
          <?php foreach ($skrektor as $skt) :
                $judul =$skt->nama_dokumen;
                ?>
          <li><img src="<?=base_url('assets/frontend/bootstrapforSPMI')?>/img/pdf.png" alt="dokumen" width="30" height="30">
            <a href="http://localhost:8080/PA2/SKRektor/<?=$judul?>"><?=$judul?></li></a>
          <?php endforeach;?>
        </ul>
        <!-- <hr> -->
