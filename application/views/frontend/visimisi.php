...
<!-- Navigation -->
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle colorDark clickedAtPage" href="#" id="navbarDropdownPortfolio" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
              Tentang Kami
            </a>
            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownPortfolio">
              <a class="dropdown-item clickedAtPage clickedAtPage1" href="http://localhost:8080/PA2/spmi/visimisi">Visi dan Misi</a>
  ...
  <!-- <nav class="navbar" style="background-color:#003366; color:white;" >
    <div class="container" >
      <div class="row">
        <div class="col-sm-12" style="text-align:right;">
 ...
 <nav aria-label="breadcrumb" >
  <ol class="breadcrumb" style="background-color:#003366;">
    <li class="breadcrumb-item" style=" margin-left: 100px;">
      <a href="#" style="color:#31B2BB;">Beranda</a></li>
    <li class="breadcrumb-item active" aria-current="page" style="color:white;">Visi dan Misi</li>
  </ol>
</nav>
        ...
        <div class="col-sm-12" style="text-align:right;">
          <ol class="breadcrumb" style="background-color:#003366;">
            <li class="breadcrumb-item">
              <a href="http://localhost:8080/PA2/spmi/index" style="color:#2f50bc;"><h4>Beranda</h4></a>
            </li>
            <li class="breadcrumb-item active" style="color:white;"><h4>Visi dan Misi</h4>V  </li>
          </ol>
        </div>
      </div>
    </div>  
...
<!--     <h1 class="mt-4 mb-3">Visi dan Misi
 ...
 -->
    ...
    <div class="row">
      ...
      <div class="col-lg-8">
        ...
        <!-- Date/Time --><br>  
        <h3>Visi</h3><!-- >Posted on January 1, 2017 at 12:00 PM</p> -->
 ...
 -->
        ...
        <p>Marroha, Menjadikan mutu sebagai ruh yang menjiwai program dan kegiatan yang diselenggarakan oleh unit kerja dan insan Institut Teknologi Del di semua Satuan Akademik dan Satuan Unit Kerja untuk mencapai karya yang bermutu dan akuntabel.</p>
          ...
          <br>  
        <h3>Fungsi</h3><!-- >Posted on January 1, 2017 at 12:00 PM</p> -->
        ...
        <p>Sebagai perangkat Institut Teknologi Del, SPM berfungsi menyelenggarakan proses penjaminan mutu terhadap program kegiatan Tridarma Perguruan Tinggi yang dijalankan di Institut Teknologi Del.</p>
 ...
 -->
        <!-- <hr> --><br>
        <h3>Tugas Umum</h3><!-- >Posted on January 1, 2017 at 12:00 PM</p> -->
