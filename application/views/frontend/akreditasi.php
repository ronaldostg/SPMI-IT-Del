...
<!-- Navigation -->
    ...
    <div class="container" style="margin-top:-20px">
      ...
      <div class="collapse navbar-collapse" id="navbarResponse">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item">
            <a class="nav-link colorDark clickedAtPage clickedAtPage1"  href="http://localhost:8080/PA2/spmi/akreditasi">Akreditasi</a>
          </li>
  ...
  <ol class="breadcrumb" style="background-color:#003366;">
    ...
    <li class="breadcrumb-item active" aria-current="page" style="color:white;">Akreditasi</li>
  </ol>
</nav>
  <!-- Page Content -->
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-lg-8">
        ...
        <!-- Date/Time -->
        <h3>Akreditasi</h3><!-- >Posted on January 1, 2017 at 12:00 PM</p> -->
        <br>
        <ul>
          <li><img src="<?=base_url('assets/frontend/bootstrapforSPMI')?>/img/pdf.png" alt="dokumen" width="30" height="30">
            <a href="http://localhost:8080/PA2/akreditasi/ITD Sertifikat Akreditasi 2018-2023.pdf">ITD Sertifikat Akreditasi 2018-2023.pdf
</a></li>
          <li><img src="<?=base_url('assets/frontend/bootstrapforSPMI')?>/img/pdf.png" alt="dokumen" width="30" height="30">
            <a href="http://localhost:8080/PA2/akreditasi/D3_TI Sertifikat Akreditasi_29 Maret 2014 sd 28 Maret 2019.pdf">D3_TI Sertifikat Akreditasi_29 Maret 2014 sd 28 Maret 2019.pdf 
</a></li>
<li><img src="<?=base_url('assets/frontend/bootstrapforSPMI')?>/img/pdf.png" alt="dokumen" width="30" height="30">
            <a href="http://localhost:8080/PA2/akreditasi/D3_TK Sertifikat Akreditasi_29 Maret 2014 sd 28 Maret 2019.pdf">D3_TK Sertifikat Akreditasi_29 Maret 2014 sd 28 Maret 2019.pdf
</a></li>
<li><img src="<?=base_url('assets/frontend/bootstrapforSPMI')?>/img/pdf.png" alt="dokumen" width="30" height="30">
            <a href="http://localhost:8080/PA2/akreditasi/D4_TI Sertifikat_23 Mei 2014-22 Mei 2019.pdf">D4_TI Sertifikat_23 Mei 2014-22 Mei 2019.pdf
</a></li>
<li><img src="<?=base_url('assets/frontend/bootstrapforSPMI')?>/img/pdf.png" alt="dokumen" width="30" height="30">
            <a href="http://localhost:8080/PA2/akreditasi/SI_SI Sertifikat Akreditasi_30 Mei 2015 sd 30 Mei 2020.pdf">SI_SI Sertifikat Akreditasi_30 Mei 2015 sd 30 Mei 2020.pdf
</a></li>
<li><img src="<?=base_url('assets/frontend/bootstrapforSPMI')?>/img/pdf.png" alt="dokumen" width="30" height="30">
            <a href="http://localhost:8080/PA2/akreditasi/S1_TI Sertifikat_30 Mei 2015-29 Mei 2020.pdf">S1_TI Sertifikat_30 Mei 2015-29 Mei 2020.pdf 
</a></li>
<li><img src="<?=base_url('assets/frontend/bootstrapforSPMI')?>/img/pdf.png" alt="dokumen" width="30" height="30">
            <a href="http://localhost:8080/PA2/akreditasi/S1_TE Sertifikat Akreditasi_3 Januari 2018 sd 3 Januari 2023.pdf">S1_TE Sertifikat Akreditasi_3 Januari 2018 sd 3 Januari 2023.pdf
</a></li>
<li><img src="<?=base_url('assets/frontend/bootstrapforSPMI')?>/img/pdf.png" alt="dokumen" width="30" height="30">
            <a href="http://localhost:8080/PA2/akreditasi/S1_TB Sertifikat Akreditasi_6 Maret 2018 sd 6 Maret 2023.pdf">S1_TB Sertifikat Akreditasi_6 Maret 2018 sd 6 Maret 2023.pdf
</a></li>
<li><img src="<?=base_url('assets/frontend/bootstrapforSPMI')?>/img/pdf.png" alt="dokumen" width="30" height="30">
            <a href="http://localhost:8080/PA2/akreditasi/S1_MR Sertifikat Akreditasi-2019-2024.pdf">8. S1_MR Sertifikat Akreditasi-2019-2024.pdf
</a></li>
        ...
        <!-- Post Content -->
        <!-- <p class="lead">Menjadi rujukan penjaminan mutu pendidikan tinggi, baik untuk aspek pendidikan, penelitian, pengabdian pada masyarakat, dan manajemen kelembagaan perguruan tinggi.</p> -->
...
<!--         <h3>Misi</h3>>Posted on January 1, 2017 at 12:00 PM</p>
        ...
        <div class="card my-4">
          ...
          <div class="card-body">
            ...
            <div class="row">
              ...
              <div class="col-lg-9" >
                <a href="#<?=$bt->id_berita?>"><p><?=$judul?></p></a>
