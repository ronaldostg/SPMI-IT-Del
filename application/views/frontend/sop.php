...
<!-- Navigation -->
    ...
    <div class="container" style="margin-top:-20px">
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle colorDark clickedAtPage clickedAtPage1" href="#" id="navbarDropdownPortfolio" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Dokumen</a>
            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownPortfolio">
              <a class="dropdown-item clickedAtPage clickedAtPage1" href="http://localhost:8080/PA2/spmi/sop">Standard Operation Procedure</a>
  ...
  <ol class="breadcrumb" style="background-color:#003366;">
    ...
    <li class="breadcrumb-item active" aria-current="page" style="color:white;">SOP</li>
  </ol>
</nav>
  <!-- Page Content -->
  <div class="container">
 ...
 -->
    ...
    <!-- <ol class="breadcrumb">
      <li class="breadcrumb-item">
        <a href="http://localhost:8080/PA2/spmi/index">Beranda</a>
      </li>
    ...
    <div class="row">
      ...
      <div class="col-lg-8">
        ...
        <!-- Date/Time -->
        <h3>Standard Operation Procedure</h3><!-- >Posted on January 1, 2017 at 12:00 PM</p> -->
        <br>
        <ul>
          <?php foreach ($sop as $skt) :
                $judul =$skt->nama_dokumen;
                ?>
          <li>
          <img src="<?=base_url('assets/frontend/bootstrapforSPMI')?>/img/pdf.png" alt="dokumen" width="30" height="30">
          <a href="http://localhost:8080/PA2/SOP/<?=$judul?>"><?=$judul?></li></a>
          <?php endforeach;?>
        </ul>
        <!-- <hr> -->
