...
<footer class="main-footer">
    ...
    <strong>Copyright &copy; 2019 <a href="https://adminlte.io">Sistem Penjaminan Mutu Internal IT Del</a>.</strong> All rights
    reserved.
  </footer>
...
<script src="<?= base_url('assets/template/back');?>/dist/js/pdf.js"></script>
<script src="<?= base_url('assets/template/back');?>/dist/js/pdf.worker.js"></script>
